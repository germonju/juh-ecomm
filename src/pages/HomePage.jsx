...
import { TrendingUp, Zap, Target, ArrowRight, BarChart3, Gauge, Shield, Briefcase, Building2, Calculator, ExternalLink, HelpCircle, CheckCircle, Award, Star, DollarSign, HeartHandshake as Handshake } from 'lucide-react';
...
const HomePage = () => {
  ...
  const services = [{
    icon: TrendingUp,
    title: 'Tracking Hub',
    description: 'Configuration complète de votre tracking e-commerce / Leadgen pour des données fiables et exploitables.',
    link: '/tracking-hub',
    color: 'cyan'
  }, {
    icon: Zap,
    title: 'GTM Server-Side',
    description: 'Implémentation du tracking côté serveur pour une précision maximale et récupérer 25 % de data supplémentaire.',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Expert Tracking Server-Side & Automatisation E-commerce | Juh Ecomm Data" />
      ...
      <div className="pt-16 lg:pt-20">
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20 lg:py-32">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto text-center">
              ...
              <div className="hero-tech">
                ...
                <div className="hero-tech-logos">
                  ...
                  <div className="tech-item">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      <img src="https://horizons-cdn.hostinger.com/a0243299-3f37-4051-bfc2-4b0057952451/ee5becf811966bb125a637ec7467b286.png" alt="GTM" />
                      <span className="tech-label">GTM</span>
                    </div>
                  </div>
                  <div className="tech-item">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      <img src="https://horizons-cdn.hostinger.com/a0243299-3f37-4051-bfc2-4b0057952451/802a19355bc675baaf8eb2023debb67d.png" alt="Google Ads" />
                      <span className="tech-label">GOOGLE ADS</span>
                    </div>
                  </div>
                  <div className="tech-item">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      <img src="https://m-img.org/spai/w_78+q_lossless+ret_img+to_webp/fr.matomo.org/wp-content/uploads/2022/04/matomo-icon-1.png" alt="Matomo" />
                      <span className="tech-label">MATOMO</span>
                    </div>
                  </div>
                  <div className="tech-item">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      <img src="https://horizons-cdn.hostinger.com/a0243299-3f37-4051-bfc2-4b0057952451/2b7b2ad999e4f858fce0f6835e3b3b61.png" alt="Addingwell" />
                      <span className="tech-label">ADDINGWELL</span>
                    </div>
                  </div>
                  <div className="tech-item">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      <img src="https://horizons-cdn.hostinger.com/a0243299-3f37-4051-bfc2-4b0057952451/2aee3187598fbea66b3bc035f399632b.png" alt="n8n" />
                      <span className="tech-label">N8N</span>
                    </div>
                  </div>
                  <div className="tech-item">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      <img src="https://horizons-cdn.hostinger.com/a0243299-3f37-4051-bfc2-4b0057952451/e5748bfaa05e4175a4fa7fe1fb0cdf0b.png" alt="Make" />
                      <span className="tech-label">MAKE</span>
                    </div>
                  </div>
                  <div className="tech-item">
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      <img src="https://raw.githubusercontent.com/lobehub/lobe-icons/refs/heads/master/packages/static-png/dark/claude-color.png" alt="Claude Anthropic logo" />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button asChild size="lg" className="bg-gradient-to-r from-cyan-500 to-violet-500 hover:from-cyan-600 hover:to-violet-600 text-white font-semibold px-8 py-6 text-lg rounded-full shadow-lg hover:shadow-cyan-500/50 transition-all">
                  <Link to="/contact" onClick={() => handleCTAClick('Démarrer un projet', 'hero')}>
                    Démarrer un projet
                    <ArrowRight className="ml-2 w-5 h-5" />
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400/10 font-semibold px-8 py-6 text-lg rounded-full transition-all">
            ...
            <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }} className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
                  ...
                  <div className="lg:col-span-4 flex flex-col items-center lg:items-center text-center">
                    <div className="relative mb-8 group">
                      ...
                      <div className="relative rounded-full p-1 bg-gradient-to-br from-white/20 to-white/5 border border-white/10 shadow-2xl">
                        <img src="https://horizons-cdn.hostinger.com/a0243299-3f37-4051-bfc2-4b0057952451/6c7788c0bd7b3b4d92ca18c20952f694.jpg" alt="Julien Germon, expert en tracking et stratégie data depuis 15 ans" className="w-48 h-48 rounded-full object-cover relative z-10" loading="lazy" />
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-3xl font-bold text-white leading-tight">
                        Julien <span className="text-slate-400 text-lg font-normal block mt-1">45 ans</span>
                      </p>
                      
                      <p className="text-slate-300 leading-relaxed text-sm lg:text-base">
                        Consultant Senior chez <a href="https://www.digitalkeys.fr" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-200 transition-colors"><strong>Digitalkeys</strong></a> le jour.
                      <br />
                        Partenaire de votre croissance le soir.
                      </p>

                      <div className="pt-6 w-full">
                         <Button asChild className="w-full bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-bold py-6 rounded-xl shadow-lg shadow-orange-900/20 border border-orange-400/20 transition-all hover:scale-[1.02]">
                  ...
                  <div className="lg:col-span-8 space-y-6">
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-colors duration-300 backdrop-blur-sm">
                      ...
                      <p className="text-slate-300 leading-relaxed text-lg">
                        J'accompagne en freelance les TPE et PME qui n'ont pas les budgets agence mais qui exigent la même qualité de résultat. Je rends accessible l'expertise des grands comptes.
                      </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-amber-500/30 transition-all duration-300 group">
                        ...
                        <ul className="space-y-3">
                          {["Les agences sont souvent inaccessibles pour les petites structures.", "Les freelances juniors manquent parfois de recul stratégique.", "Je veux démocratiser l'accès à un tracking de haute précision."].map((item, i) => (
                      ...
                      <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-amber-500/30 transition-all duration-300 group">
                        ...
                        <ul className="space-y-3">
                          {["15 ans d'expérience en marketing digital et data.", "Consultant Senior chez Digitalkeys (Poste actuel).", "Expertise certifiée Google (Analytics, Ads, GTM)."].map((item, i) => (
                            <li key={i} className="flex items-start gap-3 text-slate-300 text-sm">
                    ...
                    <div className="bg-gradient-to-br from-emerald-900/20 to-teal-900/20 border border-emerald-500/20 rounded-2xl p-6 hover:border-emerald-500/40 transition-all duration-300">
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        {["L'expertise 'Grands Comptes' adaptée à votre budget.", "Une vision stratégique globale (pas juste technique).", "Des solutions durables et conformes (RGPD, Server-Side).", "Un interlocuteur unique, senior et réactif."].map((item, i) => (
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-white/10 p-6 rounded-xl hover:bg-slate-800 hover:border-amber-500/50 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 leading-relaxed">Interventions ciblées sur des objectifs précis. Livrables clairs, sans engagement longue durée inutile.</p>
                    </div>
                  </div>
                </div>
                 ...
                 <div className="bg-slate-800/50 backdrop-blur-sm border border-white/10 p-6 rounded-xl hover:bg-slate-800 hover:border-amber-500/50 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 leading-relaxed">450 € TTC / jour. Pas de coûts cachés. Vous payez uniquement l'expertise.</p>
                    </div>
                  </div>
                </div>
                 ...
                 <div className="bg-slate-800/50 backdrop-blur-sm border border-white/10 p-6 rounded-xl hover:bg-slate-800 hover:border-amber-500/50 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 leading-relaxed">Plus de 10 ans d'expérience. Maîtrise des sujets complexes (Server-Side, Consent Mode, Attribution).</p>
                    </div>
                  </div>
                </div>
                 ...
                 <div className="bg-slate-800/50 backdrop-blur-sm border border-white/10 p-6 rounded-xl hover:bg-slate-800 hover:border-amber-500/50 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 leading-relaxed">Votre business décolle et vos besoins grandissent ? Vous avez besoin d'un suivi permanent ? Je vous mets en relation avec Digitalkeys pour un accompagnement complet adapté à votre nouvelle dimension.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div className="space-y-5">
                    ...
                    <div className="space-y-3">
                        {["Quel budget prévoir pour faire 50k€ de CA ce mois-ci ?", "À partir de quel investissement pub ma marge devient négative ?", "Combien de leads dois-je générer pour être rentable ?"].map((q, i) => (
                            <div key={i} className="flex gap-3 p-4 rounded-xl bg-indigo-900/20 border border-indigo-500/10 hover:border-indigo-500/30 transition-all hover:translate-x-1 group">
                                <div className="shrink-0 w-1 bg-indigo-500 rounded-full h-full min-h-[1rem] group-hover:bg-indigo-400 transition-colors" />
                                <p className="text-slate-300 text-sm font-medium leading-relaxed group-hover:text-slate-200 transition-colors">{q}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="flex flex-col justify-between h-full">
                    <div className="mb-6 lg:mb-0">
                        ...
                        <div className="space-y-3">
                            {["Définir vos budgets d'acquisition avec précision", "Anticiper votre rentabilité (marge brute et nette)", "Prendre des décisions data-driven"].map((b, i) => (
                                <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-emerald-900/10 border border-emerald-500/10 hover:bg-emerald-900/20 transition-all hover:shadow-lg hover:shadow-emerald-900/10">
                    ...
                    <div className="mt-6 pt-6 border-t border-slate-700/50">
                        <Button asChild size="lg" className="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold py-5 px-8 text-base rounded-xl shadow-lg hover:shadow-amber-500/30 hover:scale-[1.02] transition-all flex items-center justify-center gap-3">
                          <a href="https://simulateur.juh-ecomm.fr" target="_blank" rel="noopener noreferrer" onClick={() => handleCTAClick('Simuler ma rentabilité maintenant', 'simulator-cta')}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => {
                ...
                const colorClasses = {
                  ...
                  violet: 'from-violet-500/20 to-violet-500/0 group-hover:from-violet-500/30 border-violet-500/20 group-hover:border-violet-500/40',
                ...
                return (
                  <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.1 }}>
                    <Link to={service.link} className="group block h-full" onClick={() => handleCTAClick(service.title, 'services-section')}>
                      <div className={`h-full p-8 rounded-2xl bg-gradient-to-br ${colorClasses[service.color]} border backdrop-blur-sm hover:scale-105 transition-all duration-300`}>
                        ...
                        <div className={`flex items-center text-${service.color}-400 font-semibold group-hover:translate-x-2 transition-transform`}>
                          En savoir plus
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-5xl font-bold mb-6 text-white">
                Prêt à Optimiser Votre Tracking ?
              </h2>
              <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                Contactez-nous pour un audit gratuit de votre configuration actuelle et découvrez comment améliorer vos performances.
              </p>
              <Button asChild size="lg" className="bg-gradient-to-r from-cyan-500 to-violet-500 hover:from-cyan-600 hover:to-violet-600 text-white font-semibold px-8 py-6 text-lg rounded-full shadow-lg hover:shadow-violet-500/50 transition-all">
